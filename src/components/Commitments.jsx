...
const Commitments = () => {
  ...
  return (
    <>
      <motion.div className="lg:flex lg:justify-between mx-5 lg:mx-16 mt-16 lg:mt-20" initial={{y:100}} whileInView={{y: 0}} transition={{duration : 1}}>
        <div className="grid grid-cols-2 lg:gap-16 gap-10">
          {stats.map((stat) => (
