...
export const features = [
  {
    id: "1",
    icon: "fa-solid fa-newspaper lg:text-3xl text-xl",
    header: "Discovery",
    description:
  ...
  {
    id: "2",
    icon: "fa-solid fa-chess lg:text-3xl text-xl",
    header: "Strategy",
    description:
  ...
  {
    id: "3",
    icon: "fa-solid fa-bullseye lg:text-3xl text-xl",
    header: "Execution",
    description:
  ...
  {
    id: "1",
    icon: "fa-solid fa-ruler lg:text-3xl text-xl",
    header: "Measurements",
    description:
